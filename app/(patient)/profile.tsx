...
import { TriangleAlert as AlertTriangle, Calendar, User, Settings, Moon, Globe, Circle as HelpCircle, LogOut, ChevronRight, CreditCard as Edit, Mail, Phone, MapPin, Stethoscope, Save, X, Plus, Pencil } from 'lucide-react-native';
...
export default function ProfileScreen() {
  ...
  const handleLogout = async () => {
    ...
    Alert.alert(
      ...
      [
        { 
          text: 'Cancel', 
          style: 'cancel',
          onPress: () => console.log('🔴 User cancelled logout') // Add this
        },
        {
          text: 'Logout',
          style: 'destructive',
    ...
    console.log('🔴 Alert displayed'); // Add this to confirm Alert shows
  };
